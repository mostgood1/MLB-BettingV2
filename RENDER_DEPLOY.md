...
- Schedule fetch cache size: `MLB_SCHEDULE_FETCH_CACHE_MAXSIZE=8`
- Schedule remote cache TTL: `MLB_SCHEDULE_REMOTE_CACHE_TTL_SECONDS=10`
- Live feed cache TTL: `MLB_LIVE_FEED_CACHE_TTL_SECONDS=3`
